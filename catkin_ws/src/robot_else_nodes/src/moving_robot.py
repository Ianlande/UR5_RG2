...
class MoveGroupPythonIntefaceRobot(object):
    def __init__(self):
        #super(MoveGroupPythonIntefaceRobot, self).__init__()
    ...
    def add_object_camera(self):
        ...
        setColor(self,CameraBase1_id, 0.8, 0.8, 0.8, 1.0)
        sentColors()
    ...
    def movingPosition(self):
        ...
        self.request.target_width.data = 30.0
        resp1 = self.val(self.request)        
