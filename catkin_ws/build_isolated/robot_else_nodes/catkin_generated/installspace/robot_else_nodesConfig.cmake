...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'robot_else_nodes' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/longyucheng/robot_ur5/catkin_ws/install_isolated/${idir}'.  Ask the maintainer 'longyucheng <longyucheng@todo.todo>' to fix it.")
    endif()
