...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'robot_else_nodes' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/longyucheng/catkin_ws/install_isolated/${idir}'.  Ask the maintainer 'longyucheng <longyucheng@todo.todo>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/longyucheng/catkin_ws/install_isolated/lib;/home/longyucheng/catkin_ws/devel/lib;/opt/ros/indigo/lib)
