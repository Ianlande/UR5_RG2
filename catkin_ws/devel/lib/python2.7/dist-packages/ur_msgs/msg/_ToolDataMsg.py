...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_struct_2b2dfB2fB.pack(_x.analog_input_range2, _x.analog_input_range3, _x.analog_input2, _x.analog_input3, _x.tool_voltage_48v, _x.tool_output_voltage, _x.tool_current, _x.tool_temperature, _x.tool_mode))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.analog_input_range2, _x.analog_input_range3, _x.analog_input2, _x.analog_input3, _x.tool_voltage_48v, _x.tool_output_voltage, _x.tool_current, _x.tool_temperature, _x.tool_mode,) = _struct_2b2dfB2fB.unpack(str[start:end])
      return self
